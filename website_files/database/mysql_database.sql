...
CREATE DATABASE main_project_db;
/*
...
/* Submit & Log Items */
CREATE TABLE main_project_db.submitlog (
...
INSERT INTO main_project_db.submitlog (sl_id, item_name, location, item_type, item_desc) VALUES
...
/* Subscription Table */
CREATE TABLE main_project_db.subscription (
...
INSERT INTO main_project_db.subscription (sub_id, service, cost) VALUES
...
/* Ticket Table */
CREATE TABLE main_project_db.ticket (
...
INSERT INTO main_project_db.ticket (t_id, confirmation, type, submitted) VALUES
...
/* Login & Signup Table */
CREATE TABLE main_project_db.loginsign (
...
INSERT INTO main_project_db.loginsign (ls_id, ls_t_id, ls_sub_id, user_name, username, password, email) VALUES
...
CREATE TABLE main_project_db.searchdisplay (
...
INSERT INTO main_project_db.searchdisplay (sd_id, sl_id_FK, ls_id_FK, keyword) VALUES
(1, 2, 1, 'credit card');
INSERT INTO main_project_db.searchdisplay (sd_id, sl_id_FK, ls_id_FK, keyword) VALUES
